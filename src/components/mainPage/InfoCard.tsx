  ...
  return (  
    <div className="w-full p-3 md:p-4 dark:bg-gray-700 bg-gray-100 rounded-xl dark:text-gray-100 text-gray-900">
      ...
      <div 
        ...
        className="mt-4 md:mt-8 inline-flex py-1 md:py-2 px-2 md:px-4 text-sm md:text-base border-2 dark:border-white border-purple-500 rounded-full cursor-pointer"
      >
          Читать
      </div>
    </div>
